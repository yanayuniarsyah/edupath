...
function seed() {
  ...
  if (!db.plans.all().length) {
    db.plans.insert({ name: 'Free', price: 0, duration: 30, features: ['Akses 3 subtes dasar', 'Student Potential Path', 'Mini Kuis 5 soal/hari'] });
    db.plans.insert({ name: 'Pro', price: 149000, duration: 30, features: ['Semua subtes UTBK', 'AI Adaptive Path', 'Tryout tak terbatas', 'Laporan analitik detail'] });
    db.plans.insert({ name: 'Pro Annual', price: 990000, duration: 365, features: ['Semua fitur Pro', 'Hemat 45%', 'Konsultasi 1-on-1 bulanan'] });
